...
module.exports = function (plop) {
  ...
  plop.setGenerator("ext-user-model", {
    description: "append user-model code to a file",
    ...
    actions: [
      ...
      },
      {
        path: "{{ indexphp }}",
        type: "modify",
        pattern: /^( *)(\/\/ @PLOP_EXT_USER_MODEL)\r?\n/gim,
        templateFile: "ext-user-model.php.hbs",
      },
      function (data) {
        return F.clipboard(plop, data.indexphp, "@PLOP_EXT_USER_MODEL");
      },
    ],
  });
};
